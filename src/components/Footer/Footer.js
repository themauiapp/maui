...
const Footer = () => (
  <section className="bg-revolver-purple px-24 py-16 flex flex-col bmd:flex-row justify-between text-white quicksand">
    <div className="flex flex-col mb-3 bmd:mb-0 w-full bmd:w-48 lg:w-64 text-justify">
      <p className="text-xl mb-5 bmd:mb-4">MAUI</p>
